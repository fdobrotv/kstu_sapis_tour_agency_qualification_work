...
public interface RoomsApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"name\" : \"Номер на двоих с видом на море\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"class\" : \"FIVE\", \"pricePerNight\" : 5670 }";
    ...
    default ResponseEntity<List<Room>> listRooms(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"name\" : \"Номер на двоих с видом на море\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"class\" : \"FIVE\", \"pricePerNight\" : 5670 }, { \"name\" : \"Номер на двоих с видом на море\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"class\" : \"FIVE\", \"pricePerNight\" : 5670 }, { \"name\" : \"Номер на двоих с видом на море\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"class\" : \"FIVE\", \"pricePerNight\" : 5670 }, { \"name\" : \"Номер на двоих с видом на море\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"class\" : \"FIVE\", \"pricePerNight\" : 5670 }, { \"name\" : \"Номер на двоих с видом на море\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"class\" : \"FIVE\", \"pricePerNight\" : 5670 } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
